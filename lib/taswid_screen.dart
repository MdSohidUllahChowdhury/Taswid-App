...
import 'package:for_practice/get_logic.dart';
import 'package:get/get.dart';

class TaswidScreen extends StatelessWidget {
  const TaswidScreen({super.key});
  @override
  Widget build(BuildContext context) {
    final hitGetx = Get.put(Count());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text(
            'Tasbi Counting',
            style:
                TextStyle(fontFamily: 'Yoyo', letterSpacing: 3, fontSize: 19),
          ),
        ),
        body: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-tgOzMnw_d6Ssbcwm1-G_xjPS2pD_bdqSIw&usqp=CAU'))),
                  ),
                ),
              ],
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8GlmKgThVhKCpSc3hbLOrQWXNEEaO-jnmUgSyl6-l_t-bV26Ichq0TfAF0dQiW_LryTc&usqp=CAU'))),
            ),
            const SizedBox(
              height: 8,
            ),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr0ip7dj2YmWwTRv5_My13iEnzPTzJdxme8A&usqp=CAU'))),
                  ),
                ),
              ],
            ),
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(
                              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCsMbEGu-sWVmWUo89Lpp5PDIWDzZiXgrz8Q&usqp=CAU'))),
                  child: Stack(
                    children: [
                      Center(
                        child: InkWell(
                          onTap: () {
                            hitGetx.tapToIncrement();
                          },
                          child: Container(
                              height: 90,
                              width: 120,
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color:
                                      const Color.fromARGB(104, 11, 228, 228),
                                  boxShadow: const [
                                    BoxShadow(
