...
class _UIState extends State<UI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
backgroundColor: const Color.fromARGB(223, 0, 150, 135),
     appBar: AppBar(
      title:  Text('Tasbi Counting',
              ...
              child: Stack(
                children: [
                     ...
                     setState(() {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Color.fromARGB(104, 11, 228, 228),
                          boxShadow: [
                            BoxShadow(
                              blurRadius: 10,
                              color: Colors.black
                  ...
                  Row(
                    children: [
                      Container(
                        margin: EdgeInsets.only(left: 156,top: 30),
                        child: Text('Count Your Zikir',
                        style:TextStyle(
                          fontSize: 15,
